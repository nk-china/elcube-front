...
import '../bpmn-js-properties-panel/style/bpmn-js-properties-panel.css';
...
// import customTranslate            from '../../bpmn-js-properties-panel/lib/customTranslate/customTranslate';
import activitiExtensionModdle    from '../bpmn-js-properties-panel/resources/activiti.json';
    ...
    mounted() {
        this.$nextTick().then(() => {
            ...
            this.viewer = new BpmnModdle({
                ...
                moddleExtensions: {
                    activiti: activitiExtensionModdle
                },
            });
    ...
    methods: {
        ...
        init(){
            if(this.$route.query.from){
                const url = `/api/def/bpm/process/definition/bpmn?definitionId=${this.$route.query.from}`;
                this.$http.get(url)
                    .then(response=>{
        ...
        deploy(){
            ...
            this.getBpmn()
                .then(bpmn=>{
                    ...
                    this.$http.post("/api/def/bpm/deploy",qs.stringify(bpmn))
                        .then(response=>{
