...
import NkDefDocTypeIndexCustom from "./NkDefDocTypeIndexCustom";
...
const defaultCards = [
    ...
    {key:"cycle",   name:"业务逻辑",    defComponentNames: [NkDefDocTypeBizFlow, NkDefDocTypeCycle, NkDefDocTypeIndex, NkDefDocTypeIndexCustom, NkDefDocTypeDataSyncs]},
